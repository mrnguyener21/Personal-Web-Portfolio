...
const Projects = () => {
    return(
        <div name='project' className={styles.container}>
            <h2 className={styles.title} data-aos='fade-down' >PROJECTS</h2>
            ...
            <div className={styles.projectContainer}>
                {projects.map(({ image, name, description, technologies, sourceCode, liveDemo }) => (
                    <div  key={name} className={styles.content} data-aos='fade-right' data-aos-duration="1000" >
